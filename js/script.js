...
const brideLeft = document.getElementById('brideLeft');
const brideRight = document.getElementById('brideRight');
...
setTimeout(() => {
    ...
    word.innerText = 'Your Word Here';
}, 2000);

setTimeout(() => {
    brideLeft.classList.remove('animate-left');
    brideLeft.classList.add('animate-right');
    brideRight.classList.remove('animate-right');
    brideRight.classList.add('animate-left');
}, 4000);



// $(document).ready(function() {
//     $(".bride-animation img").css("transform", "translateX(-100%)"); // Initial position

//     setTimeout(function() {
//         $(".bride-animation img").css("transform", "translateX(0)"); // Animate to original position
